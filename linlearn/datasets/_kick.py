...
dtype = {
    ...
    "MMRAcquisitionAuctionAveragePrice": float,
    "MMRAcquisitionAuctionCleanPrice": float,
    "MMRAcquisitionRetailAveragePrice": float,
    "MMRAcquisitonRetailCleanPrice": float,
    "MMRCurrentAuctionAveragePrice": float,
    "MMRCurrentAuctionCleanPrice": float,
    "MMRCurrentRetailAveragePrice": float,
